...
with tab1:
   ...
   if os.path.exists(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'evandro.jpg')):
       st.image(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'evandro.jpg'), width=200)
...
with tab2:
   ...
   if os.path.exists(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'guilherme.jpg')):
       st.image(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'guilherme.jpg'))
...
with tab3:
   ...
   if os.path.exists(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'leticia.jpg')):
       st.image(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'leticia.jpg'), width=200)
...
with tab4:
    ...
    if os.path.exists(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'nathalia.jpg')):
        st.image(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'app_data', 'nathalia.jpg'), width=200)
